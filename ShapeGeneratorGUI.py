...
def get_user_input():
    ...
    layout = [
        ...
        [sg.Text('CP2 X-Offset Factor:', size=(25, 1)), sg.InputText(default_text='3', key='CP2_X_Offset_Factor')],
        [sg.Text('CP2 Y-Offset Factor:', size=(25, 1)), sg.InputText(default_text='3', key='CP2_Y_Offset_Factor')],
        [sg.Text('CP1 & CP3 X-Offset Factor:', size=(25, 1)), sg.InputText(default_text='3', key='CP1_3_X_Offset_Factor')],
        [sg.Text('CP1 & CP3 Y-Offset Factor:', size=(25, 1)), sg.InputText(default_text='3', key='CP1_3YX_Offset_Factor')],
...
def main():
    ...
    base_and_final = combine_and_export(final, base, export_name='full_shape.STEP')
